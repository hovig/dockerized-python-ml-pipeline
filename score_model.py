...
try:
    ...
    display = "* Model accuracy score: "+str(accuracy_score)+"<br><br>* Model confusion matrix: <br>"+str(conf_mat)+"<br><br>* Classification report: <br>"+str(class_report)+"<br><br>* Test model predictions: <br>"+str(test_pred)
except:
    print("Issue noticed")
